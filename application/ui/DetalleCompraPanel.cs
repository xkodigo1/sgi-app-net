...
namespace sgi_app.application.ui
{
    public class DetalleCompraPanel
    {
        ...
        public void ShowMenu()
        {
            while (true)
            {
                Console.WriteLine("=== Panel de Detalle de Compras ===");
        ...
        private void ListarDetalles()
        {
            ...
            {
                Console.WriteLine($"ID: {detalle.Id}, ProductoId: {detalle.ProductoId}, CompraId: {detalle.CompraId}");
            }
        }
        ...
        private void CrearDetalle()
        {
            ...
            var detalle = new DetalleCompra { Id = id, ProductoId = productoId, CompraId = compraId };
        ...
        private void EditarDetalle()
        {
            ...
            if (detalle != null)
            {
                ...
                detalle.CompraId = int.Parse(Console.ReadLine());
